...
func TestRegisterUser(t *testing.T) {
	...
	tests := map[string]struct {
		...
		"ok": {
			reqFiles: []string{
				"testdata/register_user/ok_req.json.golden",
			},
			want: want{
				status: http.StatusOK,
				rspFiles: []string{
					"testdata/register_user/ok_rsp.json.golden",
				},
			},
		},
		"invalidPassword": {
			reqFiles: []string{
				"testdata/register_user/invalid_password_length_reqs.json.golden",
				"testdata/register_user/invalid_password_upper_reqs.json.golden",
				"testdata/register_user/invalid_password_number_reqs.json.golden",
				"testdata/register_user/invalid_password_symbol_reqs.json.golden",
			},
			want: want{
				status: http.StatusBadRequest,
				rspFiles: []string{
					"testdata/register_user/invalid_password_length_rsp.json.golden",
					"testdata/register_user/invalid_password_upper_rsp.json.golden",
					"testdata/register_user/invalid_password_number_rsp.json.golden",
					"testdata/register_user/invalid_password_symbol_rsp.json.golden",
				},
			},
		},
	}
